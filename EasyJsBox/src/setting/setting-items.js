          ...
          views: [
            {
              ...
              props: {
                menu: pullDown
                  ...
                  : undefined,
                title: isCustomizeValues ? tmpItems[tmpValues.indexOf(this.get())] : tmpItems[this.get()],
...
class SettingInput extends SettingItem {
  with({ secure = false, kbType = $kbType.default, saveFunc, emptyToNull = false } = {}) {
    this.options = { secure, kbType, saveFunc, emptyToNull }
    return this
  }

  get(_default = null) {
    const value = this.setting.getOriginal(this.key, _default)
    return value === "" && this.options.emptyToNull ? null : value
  }
              ...
              },
              {
                ...
                events: {
                  tapped: () => {
                    ...
                    if (savedData && sender.text !== savedData) {
