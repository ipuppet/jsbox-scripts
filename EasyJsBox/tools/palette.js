class Palette {
    ...
    return {
      ...
      views: [
        this.templateSlider(
          ...
          [this.rgb[0], ""],
          {
            colors: [$rgb(0, this.rgb[1], this.rgb[2]), $rgb(255, this.rgb[1], this.rgb[2])],
            locations: [0, 1]
          },
          {
            ...
            events: value => {
              ...
              this.updateRGB()
              $("rgb-g-gradient").colors = [$rgb(this.rgb[0], 0, this.rgb[2]), $rgb(this.rgb[0], 255, this.rgb[2])]
              $("rgb-b-gradient").colors = [$rgb(this.rgb[0], this.rgb[1], 0), $rgb(this.rgb[0], this.rgb[1], 255)]
              return this.rgb[0]
            }
          }
        ),
        this.templateSlider(
          ...
          [this.rgb[1], ""],
          {
            colors: [$rgb(this.rgb[0], 0, this.rgb[2]), $rgb(this.rgb[0], 255, this.rgb[2])],
            locations: [0, 1]
          },
          {
            ...
            events: value => {
              ...
              this.updateRGB()
              $("rgb-r-gradient").colors = [$rgb(0, this.rgb[1], this.rgb[2]), $rgb(255, this.rgb[1], this.rgb[2])]
              $("rgb-b-gradient").colors = [$rgb(this.rgb[0], this.rgb[1], 0), $rgb(this.rgb[0], this.rgb[1], 255)]
              return this.rgb[1]
            }
          }
        ...
        this.templateSlider(
          ...
          [this.rgb[2], ""],
          {
            colors: [$rgb(this.rgb[0], this.rgb[1], 0), $rgb(this.rgb[0], this.rgb[1], 255)],
            locations: [0, 1]
          },
          {
  ...
  templateSlider(id, title, value, gradient, slider, cover = false) {
    ...
    return {
      type: "view",
      layout: (make, view) => {
        if (view.prev) make.top.equalTo(view.prev.bottom).offset(25)
